...
<?php if (('open' == $post-> comment_status) && ('open' == $post->ping_status)) : // Comments and trackbacks open ?>
					<h3><?php printf($comment_count > 1 ? __('<span>%d</span> Comments', 'sandbox') : __('<span>1</span> Comment', 'sandbox'), $comment_count) ?></h3>
<?php elseif (!('open' == $post-> comment_status) && ('open' == $post->ping_status)) : // Only trackbacks open ?>
					<h3><?php printf(__('Comments Are Closed', 'sandbox'), $comment_count) ?></h3>
...
<?php if ( ! empty($comments_by_type['pings']) ) : ?>
				...
				<div id="trackbacks-list" class="comments">
					<h3><?php printf($ping_count > 1 ? __('<span>%d</span> Trackbacks', 'sandbox') : __('<span>1</span> Trackback', 'sandbox'), $ping_count) ?></h3>
